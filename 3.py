    ...
    while True:
        ...
        for combination in itertools.product([0, 1], repeat=len(cities)):
            ...
            def objective(vars):
                ...
                if x[-1] != 0 or x[-2] != 0:
                    penalty += 1e6
                return -calculate_railway_department_profit(x, y_dict, w_dict, z_dict) + penalty

            initial_values = [1500, 0, 1500, 0] + [20, 0, 20, 0] + [0.5, 0, 0.5, 0]
            bounds = [(500, 2500), (0, 0), (500, 2500), (0, 0),
                      (10, 30), (0, 0), (10, 30), (0, 0),
                      (0.1, 0.8), (0, 0), (0.1, 0.8), (0, 0)]

            result = minimize(objective, initial_values, bounds=bounds)
