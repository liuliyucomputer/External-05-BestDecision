...
def optimize_decision():
    ...
    while True:
        ...
        for combination in itertools.product([0, 1], repeat=len(cities)):
            ...
            # 确保X1, X2为1，X(-1), X(-2)为0
            if x[1] != 1 or x[2] != 1 or x[-1] != 0 or x[-2] != 0:
                continue
            ...
            def objective(vars):
                ...
                return -calculate_railway_department_profit(x, y_dict, w_dict, z_dict)
            
            # 初始值和边界
            initial_values = [1500, 0, 1500, 0] + [20, 0, 20, 0] + [0.5, 0, 0.5, 0]
            bounds = [
                (500, 2500), (0, 0), (500, 2500), (0, 0),  # Y的边界
                (10, 30), (0, 0), (10, 30), (0, 0),        # W的边界
                (0.1, 0.8), (0, 0), (0.1, 0.8), (0, 0)     # Z的边界
            ]
