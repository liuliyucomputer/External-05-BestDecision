...
E = 1e7
A = {1: 30, -1: 60, 2: 2000, -2: 60}
a = 7000
C = 800
g = {1: 1e13, -1: 8e12, 2: 7.5e12, -2: 9e12}
p = {1: 100, -1: 900, 2: 000, -2: 100}
N = 30
cities = [1, -1, 2, -2]
...
def optimize_decision():
    ...
    # 初始化 new_best_x 和 new_best_k
    new_best_x = {city: 0 for city in cities}
    ...
    while True:
        for combination in itertools.product([0, 1], repeat=len(cities)):
            ...
            bounds = [(450, 2500)] * len(cities) + [(10, 30)] * len(cities) + [(0.1, 0.8)] * len(cities)
...
# 如果未找到最优解，则选择一个利润最高的组合
if best_x is None:
    print("No optimal solution found, selecting the highest profit combination.")
    best_x = new_best_x
    best_k = new_best_k
